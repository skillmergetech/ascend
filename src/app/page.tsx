        ...
        <section className="animate-rise">
           <Card className="border-none bg-gradient-to-r from-primary/10 via-accent/5 to-transparent backdrop-blur-xl shadow-xl overflow-hidden relative group">
             ...
             <CardContent className="p-6 md:p-8 flex flex-col md:flex-row items-center gap-6 md:gap-10 text-center md:text-left">
                ...
                <Button asChild variant="outline" className="w-full md:w-auto border-gold/30 hover:bg-gold/10 hover:border-gold font-black uppercase text-[10px] md:text-xs h-10 md:h-11">
            ...
            <Card className="border-none bg-card/40 backdrop-blur-xl shadow-2xl">
              ...
              <CardContent className="space-y-4 p-4 md:p-6 pt-0 md:pt-0">
                ...
                <div className="flex gap-2 mb-4 md:mb-6">
                  ...
                  />
                  <Button size="icon" onClick={handleQuickAdd} className="bg-accent hover:bg-accent/90 shrink-0 h-11 w-11 md:h-12 md:w-12">
                ...
                <div className="space-y-2 md:space-y-3">
                  {prioritizedTasks.length > 0 ? (
                    ...
                    <div className="text-center py-8 md:py-12 border-2 border-dashed border-muted rounded-2xl md:rounded-3xl">
                      <p className="text-muted-foreground text-xs md:text-sm">No missions active for today.</p>
                      <Button variant="link" className="text-accent text-[10px] md:text-xs mt-1" onClick={() => document.querySelector('input')?.focus()}>
            ...
            <Card className="border-none bg-card/40 backdrop-blur-xl shadow-2xl relative overflow-hidden">
              ...
              <CardContent className="space-y-6 md:space-y-8 p-4 md:p-6 pt-0 md:pt-0">
                {goals.slice(0, 3).map((goal) => (
                  <div key={goal.id} className="relative pl-8 md:pl-10 group">
                ...
                {goals.length === 0 && (
                  <p className="text-center text-[10px] md:text-xs text-muted-foreground py-4 italic">The cascade is silent. Define your vision.</p>
                )}
